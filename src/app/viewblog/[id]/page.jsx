...
const ViewBlog = () => {
    ...
    const fetchBlogDetails = () => {
        axios.get('http://localhost:5000/blog/getbyid/' + id)
            .then((result) => {
    ...
    const displayBlog = () => {
        if (blogData === null) {
            return <h1 className='text-center text-3xl font-bold text-gray-400 mt-5'>Loading...</h1>
        } else {
            return <>
                {/* Blog Article */}
                        ...
                        <div className="lg:col-span-2">
                            <div className="py-8 lg:pe-8">
                                <div className="space-y-5 lg:space-y-8">
                                    ...
                                    <MDEditor.Markdown source={blogData.content} style={{ whiteSpace: 'pre-wrap' }} />
